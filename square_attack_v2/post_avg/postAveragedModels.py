...
class PostAveragedResNet110(robustml.model.Model):
    def __init__(self, K, R, eps, device='cpu'):
        ...
        checkpoint = torch.load('/home/sandrech/code/ml/square_attack_v2/post_avg/trainedModel/resnet110.th', map_location=torch.device('cpu'))
...
def pa_resnet110_config1():
    return PostAveragedResNet110(K=15, R=6, eps=8/255, device="cpu")
